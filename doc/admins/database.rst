...
iprop_master_ulogsize  *integer*       Specifies the intended size of the incremental propagation log (ulog) file in maximum-size (63488 bytes) entries. Defaults to 1000.
